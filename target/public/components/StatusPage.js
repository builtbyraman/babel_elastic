...
function ServiceCard({ name, status, latency, info }) {
    var _a;
    return ((0, jsx_runtime_1.jsxs)(eui_1.EuiPanel, { hasBorder: true, paddingSize: "m", style: { minWidth: 220 }, children: [(0, jsx_runtime_1.jsx)(eui_1.EuiText, { size: "s", style: { fontWeight: 700, marginBottom: 6 }, children: name }), (0, jsx_runtime_1.jsxs)(eui_1.EuiFlexGroup, { gutterSize: "s", alignItems: "center", children: [(0, jsx_runtime_1.jsx)(eui_1.EuiFlexItem, { grow: false, children: (0, jsx_runtime_1.jsx)(StatusBadge, { status: status }) }), latency != null && ((0, jsx_runtime_1.jsx)(eui_1.EuiFlexItem, { grow: false, children: (0, jsx_runtime_1.jsxs)(eui_1.EuiText, { size: "xs", color: "subdued", children: [latency, "ms"] }) }))] }), (info === null || info === void 0 ? void 0 : info.version) && ((0, jsx_runtime_1.jsxs)(eui_1.EuiText, { size: "xs", color: "subdued", style: { marginTop: 4 }, children: ["v", (_a = info.version.number) !== null && _a !== void 0 ? _a : info.version] }))] }));
}
const StatusPage = ({ apiService }) => {
    ...
    const fetchStatus = (0, react_1.useCallback)(async () => {
        ...
        try {
            ...
            if (statusRes.status === 'fulfilled')
                ...
                setError(((_a = statusRes.reason) === null || _a === void 0 ? void 0 : _a.message) || 'Failed to load status');
            if (dsRes.status === 'fulfilled')
                setDataSources((_c = (_b = dsRes.value) === null || _b === void 0 ? void 0 : _b.sources) !== null && _c !== void 0 ? _c : null);
            if (reposRes.status === 'fulfilled')
                setRepos((_f = (_e = (_d = reposRes.value) === null || _d === void 0 ? void 0 : _d.data) === null || _e === void 0 ? void 0 : _e.repos) !== null && _f !== void 0 ? _f : []);
        }
        finally {
            setLoading(false);
        }
    ...
    const services = (_a = status === null || status === void 0 ? void 0 : status.services) !== null && _a !== void 0 ? _a : [];
    const availableSources = (dataSources !== null && dataSources !== void 0 ? dataSources : []).filter((s) => s.available);
    const missingSources = (dataSources !== null && dataSources !== void 0 ? dataSources : []).filter((s) => !s.available);
