...
const tdm_key_1 = require("./tdm_key");
const tdm_update_1 = require("./tdm_update");
...
const sigma_rule_registry_1 = require("./sigma_rule_registry");
...
function registerRoutes(router, _core, config) {
    ...
    (0, tdm_key_1.registerTdmKeyRoutes)(router);
    (0, tdm_update_1.registerTdmUpdateRoute)(router);
    ...
    (0, sigma_rule_registry_1.registerSigmaRuleRegistryRoutes)(router, config);
